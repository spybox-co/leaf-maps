...
import { store } from '../../../store.js'; // To-do path

import { cn } from '../../../utils/helpers'; // To-do path
...
export const Header = () => {
  ...
  return (
    <header className="spbx--header" aria-label="Leaf Maps by Spybox.co">
...
const HeaderName = ({ prefix, href, children }) => {
  return(
    <a className="spbx--header__name" href={href}>
      {prefix && (<><span className="spbx--header__name--prefix">{prefix}</span>&nbsp;</>)}
...
export const SPYBOXtypo = () => (
  <svg width="80" height="12" viewBox="0 0 970 160" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
